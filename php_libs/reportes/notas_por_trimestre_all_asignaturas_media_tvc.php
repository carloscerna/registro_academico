...
function Header()
{
    ...
    //$this->Cell(20);
    //Título
    $this->Cell(300,7,$_SESSION['institucion'],0,1,'C');
...
// QUINTA PARTE DEL RECTANGULO. NOMBRE DE LAS ASIGNATURAS
    ...
    for($i=6;$i<=$total_asignaturas;$i++)
    {
        ...
        if($i == 11){$relleno = true; $this->SetFillColor(238,255,112);$this->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$this->SetFillColor(255,255,255);$relleno = false;}
        $mover_x = $mover_x + 36;
	$this->SetFillColor(224,235,255);
    }
    }
