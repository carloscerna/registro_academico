...
// $ruta = $path_root.'/sgp_web/formatos_hoja_de_calculo/prestamos.xls';
	$ruta = $path_root.'/registro_web/formatos_hoja_de_calculo/nombre asignatura parvularia.xlsx';
		...
		while($objPHPExcel->getActiveSheet()->getCell("A".$fila)->getValue() != "")
		  {
            ...
            $query = "UPDATE asignatura SET nombre = '$descripcion' WHERE id_asignatura = $id";
