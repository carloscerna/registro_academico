...
// cuarta PARTE DEL RECTANGULO. asignatura
    ...
    $this->Rect(91,35,154,20);
    $this->Rect(91,35,154,5);
    $this->SetXY(120,35);
    $this->Cell(85,5,'ASIGNATURA',0,2,'C');
// QUINTA PARTE DEL RECTANGULO. NOMBRE DE LAS ASIGNATURAS
    ...
    for($i=0;$i<=10;$i++)
    {
        ...
        if($i == 8){$relleno = true; $this->SetFillColor(225,204,0);$this->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$this->SetFillColor(255,255,255);$relleno = false;}
        if($i == 9){$relleno = true; $this->SetFillColor(202,255,112);$this->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$this->SetFillColor(255,255,255);$relleno = false;}
        if($i == 10){$relleno = true; $this->SetFillColor(204,255,255);$this->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$this->SetFillColor(255,255,255);$relleno = false;}
        $mover_x = $mover_x + 14;
    }
...
// OCTAVA PARTE DEL RECTANGULO. Total de Puntos.
    $this->Rect(245,35,8,20);
    $this->SetFont('Arial','',9); // I : Italica; U: Normal;
    $this->RotatedText(250,54,'T.Repo',90);

// NOVENA PARTE DEL RECTANGULO. DERECHO A RECUPERACIÓN. (D. A  R.)
    $this->Rect(253,35,8,20);
    $this->SetFont('Arial','',9); // I : Italica; U: Normal;
    $this->RotatedText(257,54,'D. a R.',90);
}
//********************************************************************************************************************************
}
//************************************************************************************************************************
...
// Definimos el tipo de fuente, estilo y tamaño.
        $w2=array(5); //determina el ancho de las columnas
            $pdf->SetFont('Arial','',10); // I : Italica; U: Normal;
             ...
             $pdf->Cell(50,$w2[0],('Sección: ').$print_seccion,0,0,'L');
             $pdf->Cell(30,$w2[0],('Año Lectivo: ').$print_ann_lectivo,0,0,'L');
            $pdf->ln();
...
// variables del campo de la nota.
   ...
   $aprobada_practica = array(); $reprobada_practica = array();
   $aprobada_laboratorio = array(); $reprobada_laboratorio = array();
   
   $tapa = 0; $tapf = 0; $tapl = 0; $tapm = 0; $taps = 0; $tapc = 0;$tapi = 0; $trpl = 0; $trpf = 0; $trpc = 0; $trpm = 0; $trps = 0; $trpi = 0; $trpf = 0; $trpa = 0;
   $tapo = 0; $trpo = 0; $taph = 0; $trph = 0; $tapse = 0; $trpse = 0; $tapprac = 0; $trpprac = 0; $taplab = 0; $trplab = 0;
   $arep = 0; $aapro = 0;
   ...
   $tappracm = 0; $tappracf = 0; $trepracm = 0; $trepracf = 0;
   $taplabm = 0; $taplabf = 0; $trelabm = 0; $trelabf = 0;
		     ...
		     if($i == 9){
			   ...
			   $aprobada_seminario[] = $tapse;
			      ...
			      if ($row['genero'] == 'f'){$tapsef++;}
                         ...
                         //acumular el valor - Practica
		     if($i == 10){
                        if($row[$nota_p] < 6){
			      if ($row['genero'] == 'm'){$trepracm++;}
			      if ($row['genero'] == 'f'){$trepracf++;}
			   ...
			   // 
			   $trpprac++;
			   $reprobada_practica[] = $trpprac;}
			else{
			   $tapprac++;
			   $aprobada_practica[] = $tapprac;
			   
			      if ($row['genero'] == 'm'){$tappracm++;}
			      if ($row['genero'] == 'f'){$tappracf++;}
			}
		     }
                         //acumular el valor - Laboratorio de creatividad
		     if($i == 11){
                        if($row[$nota_p] < 6){
			      if ($row['genero'] == 'm'){$trelabm++;}
			      if ($row['genero'] == 'f'){$trelabf++;}
			   ...
			   // 
			   $trplab++;
			   $reprobada_laboratorio[] = $trplab;}
			else{
			   $tapo++;
			   $aprobada_laboratorio[] = $taplab;
			   
			      if ($row['genero'] == 'm'){$taplabm++;}
			      if ($row['genero'] == 'f'){$taplabf++;}
			}
		     }
                    }
                }
...
// QUINTA PARTE DEL RECTANGULO. NOMBRE DE LAS ASIGNATURAS
    ...
    for($i=0;$i<=10;$i++)
    {
        ...
        if($i == 5){$relleno = true; $pdf->SetFillColor(202,255,112);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        if($i == 6){$relleno = true; $pdf->SetFillColor(225,204,0);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        if($i == 7){$relleno = true; $pdf->SetFillColor(204,153,255);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        if($i == 8){$relleno = true; $pdf->SetFillColor(225,204,0);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        if($i == 9){$relleno = true; $pdf->SetFillColor(202,255,112);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        if($i == 10){$relleno = true; $pdf->SetFillColor(204,255,255);$pdf->Cell($x2,5,$data[$i],0,2,'L',$relleno);}else{$pdf->SetFillColor(255,255,255);$relleno = false;}
        $mover_x = $mover_x + 14;
...
// SEPTIMA PARTE DEL RECTANGULO.
    ...
    {    
	    ...
	    $pdf->Cell($w[2],$w2[0],$tapsef,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$tappracm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$tappracf,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$taplabm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$taplabf,0,1,'C',$fill);
	    ////////////////////////////////////////////////////////////////
	    $pdf->Cell($w[0],$w2[0],'',0,0,'C',$fill);
	    ...
	    $pdf->Cell($w[2],$w2[0],$tresef,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$trepracm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$trepracf,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$trelabm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$trelabf,0,1,'C',$fill);
	    ///////////////////////////////////////////////////////////////
	    $pdf->Cell($w[0],$w2[0],'',0,0,'C',$fill);
	    ...
	    $pdf->Cell($w[2],$w2[0],$tapsef+$tresef,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$tappracm+$trepracm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$tappracf+$trepracf,0,0,'C',$fill);

	    $pdf->Cell($w[2],$w2[0],$taplabm+$trelabm,0,0,'C',$fill);
	    $pdf->Cell($w[2],$w2[0],$taplabf+$trelabf,0,1,'C',$fill);
	    //////////////////////////////////////////////////////////////////	    
	    $pdf->Cell($w[0],$w2[0],'',0,0,'C',$fill);
	    ...
	    $pdf->Cell($w[4],$w2[0],count($aprobada_seminario) + count($reprobada_seminario),0,0,'C',$fill);
	    $pdf->Cell($w[4],$w2[0],count($aprobada_practica) + count($reprobada_practica),0,0,'C',$fill);
	    $pdf->Cell($w[4],$w2[0],count($aprobada_laboratorio) + count($reprobada_laboratorio),0,1,'C',$fill);
