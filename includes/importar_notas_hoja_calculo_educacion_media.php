...
// variables. del post.
		...
		//$nombre_de_hoja_de_calculo = "Parvularia-4 a�os seccion A.xlsx";
...
//	Variable para las actividades, nota promedio Y observaciones.
   $indicador_1 = ""; $indicador_2 = ""; $indicador_3 = ""; $indicador_final = "";
	    ...
	    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				switch ($grado)
          {
						case "EM-CC": // Educaci�n B�sica y Convivencia ciudadana
								 $letra_indicador = array("F4","G4","H4","I4","J4"); // para las asignaturas
