...
$(document).ready(function() {
    ...
    cargarDatos("#lstannlectivo", "includes/cargar-ann-lectivo.php");
    ...
    $("#lstmodalidad").change(function() {
        ...
        cargarDatosDependiente("#lstgradoseccion", "includes/cargar-grado-seccion.php", { modalidad: idModalidad });
    });

    // Continúa para Asignatura y Período
    $("#lstgradoseccion").change(function() {
        let idGradoSeccion = $(this).val();
        cargarDatosDependiente("#lstasignatura", "includes/cargar-asignatura.php", { grado_seccion: idGradoSeccion });
    });

    $("#lstasignatura").change(function() {
        let idAsignatura = $(this).val();
        cargarDatosDependiente("#lstperiodo", "includes/cargar-periodo.php", { asignatura: idAsignatura });
    });

    // Función para carga de datos independiente
    ...
    // Función para carga de datos dependientes
    function cargarDatosDependiente(selector, url, parametros) {
        $.ajax({
            url: url,
            type: "GET",
            data: parametros,
