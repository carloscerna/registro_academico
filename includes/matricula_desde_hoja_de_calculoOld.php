...
// $ruta = $path_root.'/sgp_web/formatos_hoja_de_calculo/prestamos.xls';
	$ruta = $path_root.'/registro_web/formatos_hoja_de_calculo/matricula-10498/nominas/2 A.xlsx';
		...
		while($objPHPExcel->getActiveSheet()->getCell("C".$fila)->getValue() != "")
		  {
            ...
            $apellido_paterno = $objPHPExcel->getActiveSheet()->getCell("I".$fila)->getCalculatedValue();
            $apellido_materno = $objPHPExcel->getActiveSheet()->getCell("J".$fila)->getCalculatedValue();
            $nombre_completo = $objPHPExcel->getActiveSheet()->getCell("K".$fila)->getCalculatedValue();
				
            $codigo_genero = $objPHPExcel->getActiveSheet()->getCell("M".$fila)->getCalculatedValue();
				$fecha_nacimiento = "01/01/2019";
            // DATOS PARA LA MATRICULA
            $codigo_modalidad = $objPHPExcel->getActiveSheet()->getCell("O".$fila)->getValue();
            $codigo_annlectivo = $objPHPExcel->getActiveSheet()->getCell("P".$fila)->getValue();
            $codigo_grado = $objPHPExcel->getActiveSheet()->getCell("Q".$fila)->getValue();
            $codigo_seccion = $objPHPExcel->getActiveSheet()->getCell("R".$fila)->getValue();
            $codigo_turno = $objPHPExcel->getActiveSheet()->getCell("S".$fila)->getValue();
            //$codigo_ = $objPHPExcel->getActiveSheet()->getCell("T".$fila)->getValue();
               ...
               //////////////////////////////////////////////////////////////////////////////////////////////////
                  ...
                  // armar variables.  TABS-1
                     ...
                     if($consulta -> rowCount() != 0){
                        ...
                        // Extraer el c�digo estatus u otros datos.
                        while($listado = $consulta -> fetch(PDO::FETCH_BOTH))
                           {
