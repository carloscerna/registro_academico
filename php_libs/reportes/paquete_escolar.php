...
function Header()
{
    ...
    $this->Cell(0,4,utf8_decode('Nómina de Alumnos/as'),0,1,'C');
...
//Títulos de las columnas
    $header=array('Nº','N I E','Nombre de Alumnos/as','Nombre de Padre, Madre o Encargado','DUI','FIRMA');
    $pdf->AliasNbPages();
...
//  mostrar los valores de la consulta
    ...
    $fill=false; $i=1; $m = 0; $f = 0; $suma = 0;
        while($row = $result -> fetch(PDO::FETCH_BOTH))
            ...
            $pdf->Cell($w[1],10,trim($row['codigo_nie']),'LR',0,'C',$fill); // NIE
            ...
            $pdf->Cell($w[4],10,trim($row['encargado_dui']),'LR',0,'C',$fill);    // tickert
