...
function Header(){
    ...
    $this->SetX(30);
    $this->Cell(40,4,utf8_decode('AÑO LECTIVO: '.$nombre_ann_lectivo),0,1,'L');
    $this->SetXY(0,0);
    $this->SetFont('Arial','B',6);
    $this->Cell(40,4,utf8_decode($nombre_contratacion),0,1,'L');
}
//Pie de página
function Footer(){
...
function FancyTable($header){
    ...
    $this->Cell($w2[0],5,'','LR',0,'C',1);
    $this->Cell($w2[1],5,'','LR',0,'C',1);
    $this->Cell($w2[3],5,utf8_decode('Sin Trámite'),'LBR',0,'C',1);
    $this->Cell($w2[3],5,'Saldo','LR',0,'C',1);
    // tercera fila 2 bloque
    $this->Cell($w2[3],5,utf8_decode('Con Trámite'),'LBR',0,'C',1);
    $this->Cell($w2[3],5,'Saldo','LR',0,'C',1);
