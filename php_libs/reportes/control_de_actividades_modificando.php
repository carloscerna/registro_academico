...
function Header()
{
    ...
    // Línea Horizontal. Actividades Realizadas.
        ...
        $this->RotatedText(125, 39, utf8_decode('ACTIVIDADES'), 0);    // Nombre
    ...
    if($pagina_impar == true){
        ...
        $this->SetFont('Arial','B',13);
        //Título
        $this->RotatedText(25,10,$_SESSION['institucion'],0);
...
// Creando el Informe.
    ...
    $w=array(5,70,8); //determina el ancho de las columnas
