...
class PDF extends FPDF
{
    ...
    function Header()
    {
        global $nombre_asignatura, $valor_x_encabezado, $total_asignaturas;
            ...
            switch($i)
            {
              case 1:
                ...
                $pdf->SetX(10);
                  ...
                  $pdf->Cell(20,$h[0],$row['codigo_nie'],1,0,'C',$fill);  // N| de Orden.
                  $pdf->Cell(65,$h[0],cambiar_de_del(trim($row['apellido_alumno'])),1,0,'l');  // nombre del alumno.
