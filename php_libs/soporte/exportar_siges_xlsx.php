        ...
        while($row = $result -> fetch(PDO::FETCH_BOTH))
          {
            ...
            // Evaluar si la asignatura es de CONCEPTO O CALIFICACIÓN.
                  ...
                  // convertir A FORMATO DE FECHA
                    $excelDateValue = \PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel($fecha);
                  // GRABAR EL VALOR
                  ...
                  // Nombre del archivo. Sólo el nombre de la Asignatura.
                   if($codigo_area == "09"){
                    ...
                    $nombre_archivo = htmlspecialchars(substr($codigo_asignatura_t[$i].'-'.$nombre_asignatura,0,90) . ".xlsx");
                      ...
                      chmod($DestinoArchivo.$nombre_directorio_mgs."/".$nombre_archivo,07777);
                        // Condicionar las resuestas y mensajes.
                        $mensajeError .= "<tr><td>" .$nombre_asignatura . "</td></tr>";//"Codigo Modalidad:   $codigo_modalidad  Nombre asignatura:  $nombre_asignatura ";
                    }
                   $respuestaOK = true;
