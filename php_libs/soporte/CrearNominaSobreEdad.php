...
// buscar la consulta y la ejecuta.
  consultas(22,0,$codigo_all,'','','',$db_link,'');
...
// Leemos un archivo Excel 2007
    ...
    $objPHPExcel = $objReader->load($origen."Formato - Listado - 2023 - SobreEdad.xlsx");
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //$ = trim(($row['']));
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue("D".$fila_excel,($genero_estudiante));
        $objPHPExcel->getActiveSheet()->SetCellValue("E".$fila_excel,($fecha_nacimiento));
        $objPHPExcel->getActiveSheet()->SetCellValue("F".$fila_excel,($edad));
        $objPHPExcel->getActiveSheet()->SetCellValue("G".$fila_excel, $nombre_grado_seccion);
        //
        // GENERO ESTUDIANTAE
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
   }    //  FIN DEL WHILE.
// Verificar si Existe el directorio archivos.
	...
	// Nombre del archivo.
		$nombre_archivo = replace_3($codigo_modalidad . "-". $nombre_grado ."-".$nombre_seccion." - SobreEdad.xlsx");
