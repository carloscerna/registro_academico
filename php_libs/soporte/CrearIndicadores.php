...
// Armamos el query.
  ...
  if($codigo_grado =="I3" || $codigo_grado =="4P" || $codigo_grado =="5P" || $codigo_grado =="6P"){
     print $query_asig = "SELECT aaa.codigo_asignacion, aaa.codigo_bach_o_ciclo, aaa.codigo_asignatura, aaa.codigo_ann_lectivo, aaa.codigo_sirai, aaa.codigo_grado, aaa.id_asignacion, aaa.orden,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   {      
      ...
      $objPHPExcel->getActiveSheet()->SetCellValue('AF2', "Código: " . $_SESSION["codigo_institucion"]);
   }
//
