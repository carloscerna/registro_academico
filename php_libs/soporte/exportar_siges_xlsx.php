...
if($todasLasAsignaturas == "yes"){
   // agregar CONSULTA PARA EDUCACIÒN PARVULARIA Y BASICA DE ESTANDAR DESARROLLO.
    ...
    {
      $query_todas  = "SELECT DISTINCT ON (aaa.codigo_asignatura) aaa.codigo_asignacion, aaa.codigo_bach_o_ciclo, aaa.codigo_asignatura, aaa.codigo_ann_lectivo, aaa.codigo_sirai, aaa.codigo_grado, aaa.id_asignacion, aaa.orden,
    ...
    // ejecutar la consulta.
     ...
     // para saber el nombre de la asignatura.
        $query = "SELECT * from asignatura WHERE codigo = '$codigo_asignatura'";
    // ejecutar la consulta.
    ...
    while($row = $result -> fetch(PDO::FETCH_BOTH))
      {
        ...
        // Evaluar si la asignatura es de CONCEPTO O CALIFICACIÓN.
          ...
          //
              ...
              // Destino Archivo. // Nombre del archivo. Sólo el nombre de la Asignatura.
                if($codigo_area == "09"){
                  ...
                  chmod($DestinoArchivo.$nombre_directorio_mgs."/".$nombre_archivo,07777);                         // cambiar permisos del archivo antes grabado.
                    $mensajeError .= "<tr><td>" .$nombre_asignatura . "</td></tr>";                         // Condicionar las resuestas y mensajes.
                  ...
                  $objWriter->save($DestinoArchivo.$nombre_directorio_mgs."/".$nombre_archivo); // Grabar el archivo.
                  chmod($DestinoArchivo.$nombre_directorio_mgs."/".$nombre_archivo,07777); // cambiar permisos del archivo antes grabado.
                    $mensajeError .= "<tr><td>" .$nombre_asignatura . "</td></tr>";// // Condicionar las resuestas y mensajes."Codigo Modalidad:   $codigo_modalidad  Nombre asignatura:  $nombre_asignatura ";
                }
                $respuestaOK = true;
