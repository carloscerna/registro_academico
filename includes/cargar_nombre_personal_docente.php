	...
	//	Armar query y comparar si sepuede agregar a la matriz.
		if($_SESSION['codigo_perfil'] == '04')
		{
			...
			$query_org ="SELECT org.codigo_bachillerato, bach.nombre as nombre_modalidad
							...
							WHERE org.codigo_bachillerato >= '01' and org.codigo_bachillerato <='30' and org.codigo_ann_lectivo = '$codigo_annlectivo' and org.codigo_docente = $codigo_docente";				
			}else{
			$query_org = "SELECT * FROM organizar_planta_docente_ciclos org
							WHERE org.codigo_bachillerato >= '01' and org.codigo_bachillerato <='30' and org.codigo_ann_lectivo = '$codigo_annlectivo' and org.codigo_docente = $codigo";
			}
